...
const MapToolbar = ({ role, activeTool, setTool, visionActive, onToggleVision }) => {
    const allTools = [
            ...
            {tools.map(tool => {
                ...
                return (
                    <button
                        ...
                        className={`p-3 rounded-xl transition-all relative group ${isActive ? 'bg-indigo-600 text-white shadow-lg scale-110' : 'text-slate-400 hover:text-white hover:bg-slate-800'}`}
